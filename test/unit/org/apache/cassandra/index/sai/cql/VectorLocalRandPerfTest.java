...
//    float[] queryVector;
    ...
    public void beforeTest() throws Throwable
    {
        ...
        vectors = IntStream.range(0, vectorCount).mapToObj(s -> randomVector()).collect(Collectors.toList());
//        queryVector = randomVector();

//        int step = 10 * vectorCount / limit;
//        for (int i = 0; i < vectors.size(); i += step) {
//            vectors.set(i, queryVector);
//        }

//        queryVector = vectors.get(vectorCount - 1);
        int pk = 0;
...
//        {
//            float[] q = i % 2 == 0 ? queryVector : randomVector();
