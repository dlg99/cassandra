...
abstract public class PrimaryKeyTester extends SAITester
{
    protected final PrimaryKey.Factory factory;

    protected PrimaryKeyTester(Function<ClusteringComparator, PrimaryKey.Factory> factory)
    {
        this.factory = factory.apply(new ClusteringComparator());
    }
    ...
    protected int compareBytes(PrimaryKey pk1, PrimaryKey pk2)
    {
