...
import org.apache.bookkeeper.stats.codahale.FastSnapshot;
 ...
 * calling getSnapshot().
 */
public class FastTimerFixed extends FastTimer
{
     ...
     */
    public FastTimerFixed(int timeWindowSeconds, Buckets buckets) {
        super();
